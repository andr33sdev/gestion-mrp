                  ...
                  {["TODOS", "SIN_ML", "SOLO_ML"].map((f) => (
                    <button
                      ...
                      className={`px-2 py-1 text-[10px] rounded ${
                        historialFilter === f ? "bg-blue-600" : "text-gray-400"
                      }`}
                    >
                      {f}
                    </button>
                  ...
                  <tbody>
                    {modalHistory.map((h, i) => (
                      ...
                      >
                        ...
                        <td className="p-2 font-bold text-white">{h.cant}</td>

                        {/* CAMBIO: Mostramos h.op en color azul y negrita */}
                        <td className="p-2 text-xs font-mono text-blue-400 font-bold">
                          #{h.op}
                        </td>
                      </tr>
                    ))}
